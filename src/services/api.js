...
class ApiService {
    ...
    constructor( importedClass ){
        assert( typeof importedClass.getClassifierInfoByCodes == 'function', 'Expected Api' )
    }

    async getClassifierInfoByCodes( classifierCode, codesArray ) {
